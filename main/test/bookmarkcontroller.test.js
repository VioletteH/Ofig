...
describe("bookmarksController", () => {
	...
	describe("bookmarksPage", () => {
		test('should render "favoris" with an empty bookmarks array if none exists', () => {
			...
			expect(mockResponse.render).toHaveBeenCalledWith("favoris", {
				bookmarks: [],
			});
		});
	...
	describe("bookmarksDelete", () => {
		test("should delete a figurine from bookmarks if present", async () => {
			...
			const figurineToDelete = {
				id: figurineIdToDelete,
				name: "Figurine to Delete",
			}; // Pour la comparaison dans .indexOf
