...
const mockedMainController = {
	homePage: jest.fn((res) => res.status(200).send("Home")),
	articlePage: jest.fn((res) => res.status(200).send("Article")),
	categoryPage: jest.fn((res) => res.status(200).send("Category")),
	search: jest.fn((res) => res.status(200).send("Search")),
};
...
const mockedBookmarksController = {
	bookmarksPage: jest.fn((res) => res.status(200).send("Bookmarks")),
	bookmarksAdd: jest.fn((res) => res.status(200).send("Bookmark added")),
	bookmarksDelete: jest.fn((res) => res.status(200).send("Bookmark deleted")),
};
...
const mockedCategoriesMW = jest.fn((res, next) => {
